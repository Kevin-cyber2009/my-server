...
public class Violation {
    ...
    public Violation(String student_id, String violation_type, int points_deducted, String violation_date, String school_name, String recorder_name, String recorder_class) {
